            ...
            <section className="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
                <div className="container">
                    <div className="col-12 d-flex align-items-center justify-content-center">
                        <div className="bg-dark shadow border-0 rounded border-light p-lg-5 w-100 fmxw-500">
                            ...
                            <form action="#" className="mt-04" onSubmit={onSubmit}>
                                <div className="form-group mb-4">
                                    <div className="input-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="example@company.com" id="email" autofocus required onChange={onChangeInput} />
                                    </div>
                                </div>
